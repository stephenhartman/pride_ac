...
mix.webpackConfig({
    ...
    new SWPrecacheWebpackPlugin({
        ...
        dynamicUrlToDependencies: { //you should add the path to your blade files here so they can be cached
            ...
            '/password/reset': ['resources/views/auth/passwords/reset.blade.php'],
            ...
            '/photos':['resources/views/photos/index.blade.php'],
            '/photos/create':['resources/views/photos/create.blade.php'],
            '/photos/*/edit':['resources/views/photos/edit.blade.php'],
        },
